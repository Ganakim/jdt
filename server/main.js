...
Meteor.methods({
  discordPOST(code){
    return HTTP.post(`https://discordapp.com/api/oauth2/token?client_id=548252166217924623&client_secret=${process.env.Client_Secret}&grant_type=client%5Fcredentials&scope=identify%20guilds&code=${code}`)
  },
  discordMe(res){
